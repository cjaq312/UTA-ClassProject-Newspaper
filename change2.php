...
echo"<form action='change3.php' method='post'><h3><center><u>".$publication." Publication</u></center></h3>";
...
echo"<input type='hidden' name='type' value=\"".$type."\"/><input type='hidden' name='publication' value=\"".$publication."\"/><br/><INPUT TYPE='SUBMIT'></form>";
}
?>

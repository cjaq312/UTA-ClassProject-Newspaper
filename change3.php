...
echo"<form action='change4.php' method='post'>";
...
echo"<br/>Rate:<input type='text' name='rate' value='".$r1['rate']."'>";
}
}
...
echo"<br/>Rate:<input type='text' name='rate' value='".$r2['rate']."'>";
}
}
echo"<input type='hidden' name='sid' value=".$sid."><input type='hidden' name='type' value='".$type."'><input type='submit' value='Update'></form>";
?>
